...
@Component({
    standalone: true,
    selector: 'svg-navigation-back-to-top',
    template: `
        <svg xmlns="http://www.w3.org/2000/svg" fill="#00000" viewBox="0 0 416.979 416.979" stroke-width="1.5" stroke="currentColor" class="h-6 w-6">
            <g>
                <path
...
export class NavigationBackToTopComponent {}
